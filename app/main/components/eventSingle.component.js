...
var EventSingleComponent = (function () {
    function EventSingleComponent(_authService, _alertService, _mainService, _router) {
    ...
    EventSingleComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this._mainService.getEvent(this.postID).subscribe(function (result) {
            if (result.status) {
    ...
    EventSingleComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return EventSingleComponent;
}());
exports.EventSingleComponent = EventSingleComponent;
//# sourceMappingURL=eventSingle.component.js.map