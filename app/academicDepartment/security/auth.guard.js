...
var AuthGuard = (function () {
    function AuthGuard(_alertService, _authService, _router) {
    ...
    AuthGuard.prototype.canActivate = function (route, state) {
        if (this._authService.check('currentUser')) {
            try {
                ...
                if (obj.role == "ROLE_ACADEMIC_DEPARTMENT")
                    return true;
    ...
    AuthGuard = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [alert_service_1.AlertService, authentication_service_1.AuthenticationService, router_1.Router])
    ], AuthGuard);
    return AuthGuard;
}());
