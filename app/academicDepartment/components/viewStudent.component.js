...
var ViewStudent = (function () {
    function ViewStudent(_studentService, _alertService, _authService, _router, _fb) {
    ...
    ViewStudent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ViewStudent.prototype.ngAfterViewInit = function () {
    };
    ViewStudent.prototype.addNewComment = function () {
        var _this = this;
        var comment = {
            stdID: this.stdID,
    ...
    ViewStudent.prototype.getStudentComments = function () {
        var _this = this;
    ...
    ViewStudent.prototype.ngOnDestroy = function () {
    ...
    ViewStudent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: 'ad-student',
            templateUrl: 'viewStudent.template.html',
...
//# sourceMappingURL=viewStudent.component.js.map