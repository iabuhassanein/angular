...
var Reports = (function () {
    function Reports(_reportService, _alertService, _authService, _router, _fb) {
    ...
    Reports.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    Reports.prototype.changeStatistics = function (type) {
        switch (type) {
            case 'oppPosted':
    ...
    Reports.prototype.changeReport = function (type) {
    ...
    Reports.prototype.generateReport = function (type) {
        var _this = this;
    ...
    Reports.prototype.GenerateReports = function (type) {
        var _this = this;
        switch (type) {
            case 'excel':
    ...
    Reports.prototype.downloadFile = function (url) {
    ...
    Reports.prototype.drowGraph = function (labelss, datas, time) {
